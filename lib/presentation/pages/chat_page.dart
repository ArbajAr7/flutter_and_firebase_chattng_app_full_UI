...
import 'package:t_amo/presentation/pages/sub_pages/select_contact_page.dart';
import 'package:t_amo/presentation/widgets/theme/Style.dart';
import 'package:t_amo/presentation/pages/sub_pages/single_item_chat_user_page.dart';
      ...
      body: Column(
        ...
        children: <Widget>[
          Container(
            ...
            child: Icon(Icons.message,color: Colors.white.withOpacity(.6),size: 40,),
          ),
          Align(
            child: Padding(
